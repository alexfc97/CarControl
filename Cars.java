...
class ControlPanel extends JPanel {
    ...
    // ComboBox<String> barrier_threshold = new JComboBox<String>();
...
/*
    public void barrierSetBegin() { // barrier_on.setEnabled(false); //
        barrier_off.setEnabled(false);
        barrier_threshold.setEnabled(false);
    }

    public void barrierSetEnd(int k) { // barrier_on.setEnabled(true); //
